...
function migrate(db: DB) {
  ...
  for (const [col, type] of [['late_alerted_at','TEXT'], ['receiver_confirmed_at','TEXT'], ['delivered_at','TEXT'], ['receiver_call_at','TEXT'], ['driver_whatsapp','TEXT'], ['driver_qr_requested_at','TEXT']] as const) {
